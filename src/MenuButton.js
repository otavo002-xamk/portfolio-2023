...
function MenuButton({ handleMenuChange, menuOpen }) {
  const bar1WhenMenuOpen = menuOpen
    ...
    : "bg-white dark:bg-black shadow-burgerShadow dark:shadow-darkBurger";
  ...
  return (
    ...
    >
      ...
      <div
        className={`${bar2WhenMenuOpen} duration-100 w-6 h-1 bg-white dark:bg-black mt-1 shadow-burgerShadow dark:shadow-darkBurger`}
      ></div>
