...
function LeftNavBar() {
  ...
  return (
    <ThemeContext.Consumer>
      {({ theme }) => (
        <div
          className={`bg-leftNavBar bg-cover pt-40 lg:col-start-1 lg:col-end-1 p-4 ${theme.leftNavBarBackGround}`}
        >
          <MenuButton
          ...
          <div className={`${itemsWhenMenuOpen} p-4 lg:block`}>
            <p
              className={`${
                link1Active ? "text-red-400" : theme.leftNavBarText
              } my-1 font-serif`}
            >
            ...
            <p
              className={`${
                link2Active ? "text-red-400" : theme.leftNavBarText
              } my-1 font-serif`}
            >
            ...
            <p
              className={`${
                link3Active ? "text-red-400" : theme.leftNavBarText
              } my-1 font-serif`}
            >
            ...
            <p
              className={`${
                link4Active ? "text-red-400" : theme.leftNavBarText
              } my-1 font-serif`}
            >
